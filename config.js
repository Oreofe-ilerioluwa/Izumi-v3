...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~LAAYVkHz",
  MENU_URL: process.env.MENU_URL || "https://ik.imagekit.io/eypz/1722873079279_lHOJlrddC.png",
  CAPTION: process.env.CAPTION || "Cypher",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "Ìléríolúwa",
  ...
  AUTHOR: process.env.AUTHOR || "Ìléríolúwa",
